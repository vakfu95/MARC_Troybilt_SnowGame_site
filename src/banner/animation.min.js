function spawnSnowFlake(e) {
    var t = e,
        a = Math.random() * (1.5 * s_width) - .25 * s_width,
        n = Math.random() * (2 * s_width) - .5 * s_width,
...
function everything() {
    function e() {
        if (gameStarted && !gameEnded) {
            ...
            maskThings.addChild(e), trail.push(e), drivewayMaskStage.update(), moveLeft ? (targetX -= 3, targetX < 20 && (targetX = 20), playerAngle -= 1, playerAngle < -33 && (playerAngle = -33)) : playerAngle < 0 && (playerAngle += 1), moveRight ? (targetX += 3, targetX > 490 && (targetX = 490), playerAngle += 1, playerAngle > 33 && (playerAngle = 33)) : playerAngle > 0 && (playerAngle -= 1), targetX < 30 && playerAngle < 0 && (playerAngle += 1.5, playerAngle > 0 && (playerAngle = 0)), targetX > 460 && playerAngle > 0 && (playerAngle -= 1.5, playerAngle < 0 && (playerAngle = 0)), plowClearingSquare.x += .2 * (targetX - plowClearingSquare.x), TweenMax.set(".player", {
                x: plowClearingSquare.x / 2,
                rotation: playerAngle,
                transformOrigin: "50% 15px"
            }), a.y += speed, a.y > 0 && (a.y -= 1200);
            for (var n = trail.length; n--;) {
                var r = trail[n];
                r.y += speed, r.y > 1300 && (trail.splice(n, 1), maskThings.removeChild(r), delete r)
            }
            t.seek(playerTLPosition.seekPosition), TweenMax.set(".kb1", {
                x: targetX / 2 - 18
            }), TweenMax.set(".kb2", {
                x: targetX / 2
            });
    ...
    drivewayMask = document.querySelector(".drivewaymask"), TweenMax.set(drivewayMask, {
        scale: .5,
        transformOrigin: "0% 0%"
    }), drivewayMaskStage = new createjs.Stage(drivewayMask), dmContext = drivewayMask.getContext("2d"), maskThings = new createjs.Container, drivewayMaskStage.addChild(maskThings);
    var a = new createjs.Container;
    drivewayMaskStage.addChild(a), plowClearingSquare = new createjs.Shape, plowClearingSquare.graphics.f("#ffbc33").rect(0, 0, 90, 40), plowClearingSquare.x = 254, plowClearingSquare.y = 820, maskThings.addChild(plowClearingSquare);
    var n = Object.create(pngCanvasSprites.driveway),
        r = Object.create(pngCanvasSprites.driveway);
    n.compositeOperation = "source-atop", r.compositeOperation = "source-atop", r.y = 1200, a.addChild(n), a.addChild(r), maintl.add("frame0", 0).to(".stage", .05, {
        autoAlpha: 1
    }).add("frame1", "+=.5").staggerFrom(".start-text", .75, {
        x: 300,
        ease: Power3.easeOut
    }, .5, "frame1").staggerFrom(".start-box", .75, {
        x: 300,
        ease: Power3.easeOut
    }, .5, "frame1").from(".start-box34, .start-text34", .75, {
        x: 300,
        ease: Power3.easeOut
    }, "frame1+=1").from(".intro-box", 1, {
        y: 600,
        ease: Power3.easeOut
    }, "frame1+=1.5").seek(0), createjs.Ticker.setFPS(60), createjs.Ticker.addEventListener("tick", e), createjs.Ticker.init(), initPlayerControls(t), setupCarousel()
}
...
function spawnGameElement() {
    ...
    a < .5 ? (TweenMax.set(e, {
        y: -100,
        x: 50 + 200 * Math.random()
    }), t = "snowflake") : a >= .5 && a < .6 ? (TweenMax.set(e, {
        y: -100,
        x: 50 + 200 * Math.random()
    }), t = "mitten") : a >= .6 && a < .9 ? (TweenMax.set(e, {
        y: -100,
        x: 50 + 200 * Math.random()
    }), t = "newspaper") : a >= .9 && (t = "drift", Math.random() > .5 ? TweenMax.set(e, {
        y: -100,
        x: 180 + 10 * Math.random()
    }) : TweenMax.set(e, {
        y: -100,
        x: -90 - 30 * Math.random()
    })), e.classList.add("png-element"), e.classList.add(t), gameElements.push(e), e.collectionChecked = !1, e.elementType = t, gameElementContainer.appendChild(e)
}
...
function updateGameElements() {
    for (var e = gameElements.length; e--;) {
        ...
        if (TweenMax.set(t, {
            y: "+=" + .5 * speed
        }), t._gsTransform.y > 400 && !t.collectionChecked) {
            t.collectionChecked = !0;
            var a = {
                left: t._gsTransform.x - 33,
                right: t._gsTransform.x
            };
            "drift" === t.elementType && (a.right += 250), "newspaper" === t.elementType && (a = {
                left: t._gsTransform.x - 45,
                right: t._gsTransform.x + 20
            }), "mitten" === t.elementType && (a = {
                left: t._gsTransform.x - 45,
                right: t._gsTransform.x + 15
            }), "snowflake" === t.elementType && (a = {
                left: t._gsTransform.x - 45,
                right: t._gsTransform.x + 10
            });
            var n = {
                left: targetX / 2 - 18,
                right: targetX / 2
...
function scoreTheElement(e) {
    var t, a, n, r, o = document.querySelector(".points-card");
    switch (gameElementContainer.appendChild(e), e.elementType) {
        case "drift":
            r = 100, points.points += r;
            break;
        case "newspaper":
            r = -50, points.points -= 50, t = Math.random() * -50 - 25, a = Math.random() * -50 - 50, n = 1080 * Math.random() + 360, TweenMax.to(e, .75, {
                x: t,
                y: a,
                scale: 3,
                rotation: n
            ...
            break;
        case "mitten":
            r = -25, points.points -= 25, t = Math.random() * -50 - 25, a = Math.random() * -50 - 50, n = 1080 * Math.random() + 360, TweenMax.to(e, .75, {
                x: t,
                y: a,
                scale: 3,
                rotation: n
            ...
            break;
        case "snowflake":
            r = 10, points.points += r, TweenMax.to(e, .35, {
                autoAlpha: 0,
                delay: .3,
                ease: Back.easeIn,
                onComplete: function () {
    ...
    r < 0 ? (pointCardDisplay.innerHTML = r.toString(), pointCardDisplay.innerText = r.toString(), pointCardDisplay.style.display = "none", pointCardDisplay.style.offsetHeight, pointCardDisplay.style.display = "", o.classList.add("bad-points")) : (pointCardDisplay.innerHTML = "+" + r.toString(), pointCardDisplay.innerText = "+" + r.toString(), pointCardDisplay.style.display = "none", pointCardDisplay.style.offsetHeight, pointCardDisplay.style.display = "", o.classList.remove("bad-points")), TweenMax.killDelayedCallsTo(clearPointsCard), TweenMax.fromTo(o, .5, {
        ...
        y: 0,
        ease: Power2.easeOut
    }), TweenMax.delayedCall(1, clearPointsCard), TweenMax.to(points, .5, {
...
function initRoadLoopTimeline() {
    roadLoopTL = new TimelineMax, roadLoopTL.to(".road .png-element", 5, {
        repeat: -1,
        ease: Power0.easeNone,
        y: 600
    }, 0)
...
function initPlayerLoopTimeline() {
    walkCycleTL = new TimelineMax, walkCycleTL.add("frame0", 0).to(".blower-tread", .333, {
        y: -6,
        ease: Power0.easeNone,
        repeat: 6
    }, "frame0").to(".poof_1", 1, {
        ...
        ease: Power0.easeNone,
        repeat: 0
    }, "frame0").to(".full-leg-left", .5, {
        y: -10,
        yoyo: !0,
        ease: Power1.easeInOut,
        repeat: 4,
        transformOrigin: "50% 100%"
    }, "frame0").to(".person-foot-left", .5, {
        y: -3,
        yoyo: !0,
        ease: Power1.easeInOut,
        repeat: 4,
        transformOrigin: "50% 100%"
    }, "frame0").to(".full-leg-right", .5, {
        y: 10,
        yoyo: !0,
        ease: Power1.easeInOut,
        repeat: 4,
        transformOrigin: "50% 100%"
    }, "frame0").to(".person-foot-right", .5, {
        y: 3,
        yoyo: !0,
        ease: Power1.easeInOut,
        repeat: 4,
...
function initPlayerTimeline() {
    return playerTurnTL = new TimelineMax, playerTurnTL.add("left", 0).to(".snow-blower", .5, {
        rotation: -15,
        ease: Power1.easeInOut,
        ...
        ease: Power1.easeInOut,
        transformOrigin: "50% 100%"
    }, "left").add("center", .5).to(".snow-blower", .5, {
        rotation: 0,
        ease: Power1.easeInOut,
        transformOrigin: "50% 60%"
    }, "center").to(".person", .5, {
        ...
        ease: Power1.easeInOut,
        transformOrigin: "50% 0%"
    }, "center").to(".person-arm-left", .5, {
        scaleY: 1,
        rotation: 0,
        ease: Power1.easeInOut,
        transformOrigin: "50% 100%"
    }, "center").to(".person-arm-right", .5, {
        scaleY: 1,
        rotation: 0,
        ease: Power1.easeInOut,
        transformOrigin: "50% 100%"
    }, "center").add("right", 1).to(".snow-blower", .5, {
        rotation: 15,
        ease: Power1.easeInOut,
        transformOrigin: "50% 60%"
    }, "right").to(".person", .5, {
        ...
        ease: Power1.easeInOut,
        transformOrigin: "50% 100%"
    }, "right").add("center2", 1.5).to(".snow-blower", .5, {
        rotation: 0,
        ease: Power1.easeInOut,
        transformOrigin: "50% 60%"
    }, "center2").to(".person", .5, {
        ...
        ease: Power1.easeInOut,
        transformOrigin: "50% 0%"
    }, "center2").to(".person-arm-left", .5, {
        scaleY: 1,
        rotation: 0,
        ease: Power1.easeInOut,
        transformOrigin: "50% 100%"
    }, "center2").to(".person-arm-right", .5, {
        scaleY: 1,
        rotation: 0,
        ease: Power1.easeInOut,
        transformOrigin: "50% 100%"
    }, "center2").stop(), playerTurnTL
}

function initPlayerControls(e) {
    function t(e) {
        e = e || window.event, TweenMax.to(".arrows", .5, {
            autoAlpha: 0,
            y: 10
        }), "37" == e.keyCode || "65" == e.keyCode ? (moveLeft || TweenMax.fromTo(playerTLPosition, .7, {
            seekPosition: 0
        }, {
            seekPosition: 1
        }), moveLeft = !0) : "39" == e.keyCode || "68" == e.keyCode ? (moveRight || TweenMax.fromTo(playerTLPosition, .7, {
            seekPosition: 1
        }, {
            seekPosition: 2
        }), moveRight = !0) : "38" == e.keyCode || "40" == e.keyCode
    }
...
function startGame() {
    gameStarted || (console.log("START GAME!"), gameStarted = !0, TweenMax.delayedCall(1, startTimer), initRoadLoopTimeline(), TweenMax.to(".arrows", .5, {
        y: 0,
        autoAlpha: 1
    }), TweenMax.fromTo(".score, .clock-container", .5, {
        y: -50
    }, {
        y: 0,
        ease: Power1.easeOut
...
function startTimer() {
    console.log("--startTimer--"), totalTime = 30, displayTime.innerHTML = totalTime, displayTime.innerText = totalTime, displayTime.style.display = "none", displayTime.style.offsetHeight, displayTime.style.display = "", updateTime()
}

function updateTime() {
    totalTime -= 1, totalTime <= 0 ? (totalTime = 0, TweenMax.killDelayedCallsTo(updateTime), finishGame()) : TweenMax.delayedCall(1, updateTime), displayTime.innerHTML = totalTime, displayTime.innerText = totalTime, displayTime.style.display = "none", displayTime.style.offsetHeight, displayTime.style.display = "", console.log("updateTime-totalTime:", totalTime, displayTime)
}

function finishGame() {
    console.log("FINISH GAME!"), currentProduct = 0, gameStarted = !1, gameEnded = !0, autoScroll = !0, "" == playAgainPointsDisplay.innerHTML && (playAgainPointsDisplay.innerHTML = "0", playAgainPointsDisplay.innerText = "0", playAgainPointsDisplay.style.display = "none", playAgainPointsDisplay.style.offsetHeight, playAgainPointsDisplay.style.display = ""), points.points <= 0 ? (TweenMax.set(".end-text-try-again", {
        autoAlpha: 1
    }), TweenMax.set(".end-text-nice-work", {
        autoAlpha: 0
    })) : (TweenMax.set(".end-text-try-again", {
        autoAlpha: 0
    }), TweenMax.set(".end-text-nice-work", {
        autoAlpha: 1
    })), roadLoopTL.stop(), TweenMax.to(".end-frame", .5, {
        x: 0,
        ease: Power2.easeOut,
        delay: 1.5
    }), TweenMax.delayedCall(5, hideProductMessage, [!0]), TweenMax.to(".score, .clock-container", .5, {
        y: -50,
        ease: Power1.easeOut
...
function hideProductMessage(e) {
    console.log("hideProductMessage"), e ? (TweenMax.to(".product-message", .5, {
        autoAlpha: 0,
        ease: Power2.easeInOut
    }), TweenMax.delayedCall(.75, showProducts, [!0])) : (TweenMax.to(".product-message", .5, {
        autoAlpha: 1
    }), TweenMax.delayedCall(.75, showProducts, [!1]))
}

function showProducts(e) {
    console.log("showProducts"), e ? (TweenMax.to(".end-text-browse", .5, {
        autoAlpha: 1,
        ease: Power2.easeOut
    }), TweenMax.to(".product", .5, {
        autoAlpha: 1,
        ease: Power2.easeOut,
        delay: .4
    }), TweenMax.to(".products-navigation", .5, {
        autoAlpha: 1,
        ease: Power2.easeOut,
        delay: .8
    })) : (TweenMax.to(".end-text-browse", .5, {
        autoAlpha: 0
    }), TweenMax.to(".product", .5, {
        autoAlpha: 0
    }), TweenMax.to(".products-navigation", .5, {
...
function resetScore() {
    points = {
        points: 0,
        displayPoints: 0
    }, scoreDisplay.innerHTML = 0, scoreDisplay.innerText = 0, scoreDisplay.style.display = "none", scoreDisplay.style.offsetHeight, scoreDisplay.style.display = "", playAgainPointsDisplay.innerHTML = 0, playAgainPointsDisplay.innerText = 0, playAgainPointsDisplay.style.display = "none", playAgainPointsDisplay.style.offsetHeight, playAgainPointsDisplay.style.display = ""
}

function reset() {
    if (!gameStarted) {
        TweenMax.to(".end-frame", .75, {
            x: -300,
            ease: Power4.easeIn
        }), TweenMax.delayedCall(.75, resetScore), TweenMax.delayedCall(.75, hideProductMessage, [!1]), TweenMax.killDelayedCallsTo(autoPaginate), TweenMax.delayedCall(.75, updateCarousel, [0]), TweenMax.delayedCall(.75, updateNavigation, [0]);
        for (var e = 0; e < gameElements.length; e++) {
            var t = gameElements[e];
            t.remove()
        }
        gameElements = [], targetX = 254, TweenMax.set(".player", {
            x: targetX / 2,
            rotation: 0,
            transformOrigin: "50% 15px"
...
function replayGame() {
    console.log("replayGame"), TweenMax.delayedCall(1, startTimer), TweenMax.fromTo(".arrows", .5, {
        autoAlpha: 0,
        y: 10
    }, {
        autoAlpha: 1,
...
function setupCarousel() {
    console.log("--> setupCarousel"), productsCarousel = document.querySelector(".products-carousel"), productsNavigation = document.querySelector(".products-navigation"), productsArray = new Array, buttonsArray = new Array;
    for (var e = 0; e < 4; e++) {
        var t = document.createElement("div");
        t.classList.add("png-element"), t.classList.add("product");
        var a = e + 1,
            n = "product" + a;
        switch (t.classList.add(n), TweenMax.set(t, {
            x: 260 * e,
            autoAlpha: 0
        }), e) {
            case 0:
                t.addEventListener(myEvent, function () {
                    autoScroll = !1, window.open("https://www.troybilt.com/en_US/two-stage-snow-blowers/storm-3090-snow-blower/31AH5DP5766.html", "_blank")
                });
                break;
            case 1:
                t.addEventListener(myEvent, function () {
                    autoScroll = !1, window.open("https://www.troybilt.com/en_US/two-stage-snow-blowers/storm-2665-snow-blower/31AM6CP3723.html", "_blank")
                });
                break;
            case 2:
                t.addEventListener(myEvent, function () {
                    autoScroll = !1, window.open("https://www.troybilt.com/en_US/single-stage-snow-blowers/squall-208e-snow-blower/31AS2T7G766.html", "_blank")
                });
                break;
            case 3:
                t.addEventListener(myEvent, function () {
                    autoScroll = !1, window.open("https://www.troybilt.com/en_US/two-stage-snow-blowers/arctic-storm-30-snow-blower/31AH8DR5766.html", "_blank")
                })
        }
        productsArray.push(t), productsCarousel.appendChild(t);
        var r = document.createElement("div");
        r.classList.add("float"), r.classList.add("carousel-button"), r.classList.add("button"), n = "carousel-button" + a, r.classList.add(n), r.buttonType = n, 0 == e && r.classList.add("selected");
        var o = 17 + 20 * e;
        TweenMax.set(r, {
            x: o
        }), buttonsArray.push(r), productsNavigation.appendChild(r), r.addEventListener(myEvent, clickCarousel)
    }
    TweenMax.set(".end-text-browse, .products-navigation", {
        autoAlpha: 0
    }), carouselLeft = document.createElement("div"), carouselLeft.classList.add("png-element"), carouselLeft.classList.add("carousel-arrow"), carouselLeft.classList.add("carousel-left"), carouselLeft.classList.add("button"), carouselLeft.buttonType = "carousel-left", carouselLeft.addEventListener(myEvent, clickCarousel), productsNavigation.appendChild(carouselLeft), carouselRight = document.createElement("div"), carouselRight.classList.add("png-element"), carouselRight.classList.add("carousel-arrow"), carouselRight.classList.add("carousel-right"), carouselRight.classList.add("button"), carouselRight.buttonType = "carousel-right", carouselRight.addEventListener(myEvent, clickCarousel), productsNavigation.appendChild(carouselRight)
}
...
function updateCarousel(e) {
    var t = e * -260;
    console.log("newNumber: " + t), TweenMax.to(productsCarousel, 1, {
        x: t,
        ease: Power2.easeInOut
...
var maintl;
maintl = new TimelineMax, window.onload = function () {
    everything()
};
var points = {
    points: 0,
    ...
    productsArray, carouselButtonsArray, totalTime = 30,
    displayTime = document.querySelector(".clock-container .time-text"),
    gameStarted = !1,
    gameEnded = !1,
    drivewayMask, dmContext, touching = !1,
    autoScroll = !1;
TweenMax.set(".end-frame", {
    x: -300
}), TweenMax.set(".footer", {
    autoAlpha: 0
}), TweenMax.set(".drift", {
    ...
    autoAlpha: 0,
    y: 10
}), TweenMax.set(".score, .clock-container", {
    y: -50
});
var stage = document.querySelector(".stage"),
    ...
    speed = 5;
initSnowFlakes();
var plowClearingSquare, drivewayMaskStage, maskThings, myEvent = "ontouchstart" in document.documentElement ? "touchend" : "click";
console.log("myEvent: " + myEvent), "touchend" == myEvent ? (TweenMax.set(".arrows-mobile", {
    autoAlpha: 1
}), TweenMax.set(".arrows-desktop", {
    autoAlpha: 0
})) : (TweenMax.set(".arrows-mobile", {
    autoAlpha: 0
}), TweenMax.set(".arrows-desktop", {
    autoAlpha: 1
}));
var swipeFunc = {
    ...
    touchHandler: function (e) {
        var t;
        if (!gameEnded && "undefined" != typeof e && (e.preventDefault(), "undefined" != typeof e.touches)) switch (t = e.touches[0], e.type) {
            case "touchstart":
                touching = !0;
            case "touchmove":
                ...
                break;
            case "touchend":
                touching = !1, gameStarted && !gameEnded && (moveLeft = !1, moveRight = !1, TweenMax.to(".arrows", .5, {
                    autoAlpha: 0,
                    y: 10
                }))
        }
    ...
    init: function () {
        document.querySelector(".stage").addEventListener("touchstart", swipeFunc.touchHandler, !1), document.querySelector(".stage").addEventListener("touchmove", swipeFunc.touchHandler, !1), document.querySelector(".stage").addEventListener("touchend", swipeFunc.touchHandler, !1)
    }
};
swipeFunc.init();
var walkCycleTL, walkCycleSeek = 1 / 60,
    carouselLeft, carouselRight, productsCarousel, productsNavigation, buttonsArray, currentProduct = 0;
document.querySelector(".intro-cta-button").addEventListener("mouseover", function () {
    TweenMax.to(".intro-cta-button", .1, {
        backgroundColor: "#FFFFFF",
        ease: Power2.easeOut
    }), TweenMax.to(".intro-cta-rollover", .1, {
        autoAlpha: 1,
        ease: Power2.easeOut
    })
}), document.querySelector(".intro-cta-button").addEventListener("mouseout", function () {
    TweenMax.to(".intro-cta-button", .25, {
        backgroundColor: "#000000",
        ease: Power2.easeOut
    }), TweenMax.to(".intro-cta-rollover", .25, {
        autoAlpha: 0,
        ease: Power2.easeOut
    })
}), document.querySelector(".intro-cta-button").addEventListener(myEvent, function () {
    console.log("intro-cta-button is clicked"), TweenMax.to(".start-frame", .75, {
        x: -300,
        ease: Power4.easeIn
    })
}), document.querySelector(".mid-cta-button").addEventListener("mouseover", function () {
    TweenMax.to(".mid-cta-button", .1, {
        backgroundColor: "#FFFFFF",
        ease: Power2.easeOut
    }), TweenMax.to(".mid-cta-rollover", .1, {
        autoAlpha: 1,
        ease: Power2.easeOut
    })
}), document.querySelector(".mid-cta-button").addEventListener("mouseout", function () {
    TweenMax.to(".mid-cta-button", .25, {
        backgroundColor: "#da0026",
        ease: Power2.easeOut
    }), TweenMax.to(".mid-cta-rollover", .25, {
        autoAlpha: 0,
        ease: Power2.easeOut
    })
}), document.querySelector(".mid-cta-button").addEventListener(myEvent, function () {
    TweenMax.to(".mid-box", .75, {
        x: -300,
        ease: Power4.easeIn
    }), TweenMax.to(".black-overlay", .75, {
        autoAlpha: 0,
        ease: Power2.easeOut,
        delay: 1,
    ...
    TweenMax.to(".play-again-button", .1, {
        backgroundColor: "#FFFFFF",
        ease: Power2.easeOut
    }), TweenMax.to(".play-again-rollover", .1, {
        autoAlpha: 1,
        ease: Power2.easeOut
    })
}), document.querySelector(".play-again-button").addEventListener("mouseout", function () {
    TweenMax.to(".play-again-button", .25, {
        backgroundColor: "#000000",
        ease: Power2.easeOut
    }), TweenMax.to(".play-again-rollover", .25, {
        autoAlpha: 0,
        ease: Power2.easeOut
    })
    ...
    TweenMax.to(".share-facebook", .1, {
        backgroundColor: "#4267B2",
        ease: Power2.easeOut
    })
}), document.querySelector(".share-twitter").addEventListener("mouseover", function () {
    TweenMax.to(".share-twitter", .1, {
        backgroundColor: "#1DA1F2",
        ease: Power2.easeOut
    })
}), document.querySelector(".share-facebook").addEventListener("mouseout", function () {
    TweenMax.to(".share-facebook", .25, {
        backgroundColor: "#000000",
        ease: Power2.easeOut
    })
}), document.querySelector(".share-twitter").addEventListener("mouseout", function () {
    TweenMax.to(".share-twitter", .25, {
        backgroundColor: "#000000",
        ease: Power2.easeOut
    })
}), document.querySelector(".share-facebook").addEventListener(myEvent, function () { }), document.querySelector(".share-twitter").addEventListener(myEvent, function () { }), document.querySelector(".cta-button").addEventListener("mouseover", function () { }), document.querySelector(".cta-button").addEventListener("mouseout", function () { }), document.querySelector(".cta-button").addEventListener(myEvent, function () {
